  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Create buyer account</h1>
        <p className="text-gray-500 text-sm mb-6">Register to place orders and track deliveries</p>
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-800 mb-2">Village</label>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          Already registered? <Link href="/buyer/login" className="text-green-600 font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
